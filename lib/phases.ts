...
export const PHASE_WINDOWS = {
  REGISTRATION_CLOSE: new Date('2026-05-14T21:00:00+05:30'),
  HACKATHON_START:    new Date('2026-05-14T21:00:00+05:30'),
  CORE_WINDOW_END:    new Date('2026-05-14T21:10:06+05:30'), // 10 minute core lock window from now
